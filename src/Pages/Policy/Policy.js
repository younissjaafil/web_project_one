...
function Policy() {
  return (
    <>
      <div id="policyPageNavLink" className="policy">
        <h1>Platform Usage & Privacy Policy</h1>
        <p className="policy-intro">
          Welcome to EventLiu – the official club events platform for university
          organizations. Please read the following policy carefully to
          understand how we ensure safe, transparent, and responsible use of our
          services.
        </p>
        ...
        <div className="policy-content">
          <section className="policy-section">
            ...
            <p>
              Only officially registered university clubs or student
              organizations are allowed to create and manage events on this
              platform. Unauthorized use is prohibited.
            </p>
          </section>
          ...
          <section className="policy-section">
            ...
            <p>
              ...
              preferences solely to improve the platform experience. Data is
          ...
          <section className="policy-section">
            <h2>4. Media Usage</h2>
            <p>
              Photos or videos taken during club events may be used in
              university promotional content unless explicitly opted out by the
              club during event creation.
            </p>
          </section>
